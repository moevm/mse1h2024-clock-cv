<template>
    ...
    <div class="block1">
        <div class="forms">
            ...
            <div class="Rectangle3">
                <input id="emailInput" type="email" class="Input" placeholder="Почта">
            </div>
            <div class="Rectangle3">
            ...
            <button class="loginknop1">Зарегистрироваться</button>
        </div>
        <div class="blockinf" style="text-align:center">
            <p class="text4">Уже есть учетная запись? <router-link to="/" class="link">Войти<br/></router-link></p>
